...
get_coverage_perc:
	...
	LINE_COVERAGE_PERCENTAGE_AUX=$${LINE_COVERAGE_PERCENTAGE//.} ;\
	FUNC_COVERAGE_PERCENTAGE_AUX=$${FUNC_COVERAGE_PERCENTAGE//.} ;\
	COVERAGE_THRESHOLD_AUX=$(COVERAGE_THRESHOLD); \
	COVERAGE_THRESHOLD_AUX=$${COVERAGE_THRESHOLD_AUX//.} ;\
	err=0;\
