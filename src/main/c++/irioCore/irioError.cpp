...
const std::unordered_map<TErrorDetailCode, std::string> errorMap = {
	{Generic_Error,
	 "Error generated outside irio. "
	 "Check error messages for more detailed information"},
	{HardwareNotFound_Error,
	 "Specified RIO device not found. "
	 "Review specified serial number."},
	{BitfileDownload_Error,
	 "Error occurred downloading the bitfile. "
	 "Check if bitfile was compiled for the specified target."},
	{InitDone_Error,
	 "Init done wait ended in timeout. "
	...
	{IOModule_Error,
	 "Connected IO module is not the expected IO Module. "
	 "Review bitfile downloaded."},
	{NIRIO_API_Error,
	 "NI-RIO C API returned error. "
	 "Check returned error in error log."},
	{ListRIODevicesCommand_Error,
	 "System call for listing connected RIO devices "
	 "failed. Check if NI-RIO driver is installed "
	 "and the executable is accessible."},
	{ListRIODevicesParsing_Error,
	 "Failed to parse system call for listing "
	 "connected RIO. Check version of "
	 "NI-RIO Driver installed."},
	{SignatureNotFound_Error,
	 "Can't find bitfile signature string in the "
	 "given header file. "
	 "Check NI FPGA C API Generator version used."},
	{ResourceNotFound_Error,
	 "A mandatory resource wasn't found. "
	 "Check error messages to find missing resources."},
	{SignatureValueNotValid_Error,
	 "Can't read value of bitfile signature "
	 "in the given header file. "
	 "Check NI FPGA C API Generator version used."},
	{ResourceValueNotValid_Error,
	 "Can't read address of a resource in the "
	 "given header file. "
	 "Check NI FPGA C API Generator version used."},
	{MemoryAllocation_Error,
	 "IRIO tried to allocate memory unsuccessfully. "
	 "Check possible memory leaks in user application."},
	{BitfileNotFound_Error,
	 "Bitfile file for specified project was not found. "
	 "Check project name and search path."},
	{HeaderNotFound_Error,
	 "Header file for specified project was not found. "
	 "Check project name and search path."},
	{FileAccess_Error,
	 "A problem occur while reading a file. "
	 "Check file permissions."},
	{FileNotFound_Error,
	 "Tried to open a file and failed. "
	 "Check file name and search path."},
	{FeatureNotImplemented_Error,
	 "The target device or device profile are not "
	 "supported. Check values in the project "
	 "with the design rules"},
	{Success, "Device status is OK"},
	{TemporaryFileDelete_Warning,
	 "Could not delete temporary file. "
	 "Check /tmp/ folder permissions "
	 "or previous warnings/errors."},
	{ResourceNotFound_Warning,
	 "An optional resource (or part of it for complex "
	 "resources) wasn't found. Check error messages to "
	 "find missing resources."},
	{FPGAAlreadyRunning_Warning,
	 "Tried change FPGAStart value after FPGA was "
	...
	{Read_NIRIO_Warning,
	 "Tried to access an existing FPGA resource "
	 "unsuccessfully. Check error messages to "
	 "find NI-RIO driver error code."},
	{Read_Resource_Warning,
	 "Tried to access a non-existing FPGA resource. "
	 "Check implemented resources in the project or "
	 "enabling verbosity mode in irio_initDriver call."},
	{Write_NIRIO_Warning,
	 "Tried to write in an existing FPGA resource "
	 "unsuccessfully. "
	 "Check error messages to find NI-RIO driver error code."},
	{Write_Resource_Warning,
	 "Tried to write in a non-existing FPGA resource. "
	 "Check implemented resources in the project or "
	 "enabling verbosity mode in irio_initDriver call."},
	{ConfigDMA_Warning,
	 "Tried to configure/start/stop DMA FIFO unsuccessfully. "
	 "Check error messages to find NI-RIO driver error code."},
	{ConfigUART_Warning,
	 "Tried to configure UART baud rate unsuccessfully. "
	 "UART seems busy."},
	{ValueOOB_Warning,
	 "Tried to write a value Out of Bounds. "
	 "Check design rules for operational range."},
	{Generic_Warning,
	 "Warning generated outside irio. "
	 "Check warning messages for more detailed information"},
	{DAQtimeout_Warning,
	 "Timeout reached when waiting for data "
	 "from data acquisition"},
	{CLSLinetimeout_Warning,
	 "Timeout reached when waiting "
