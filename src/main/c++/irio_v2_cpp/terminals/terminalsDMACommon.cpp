...
//void TerminalsDMACommon::configureDMA(const std::uint32_t n, const size_t depth) const {
//	const auto status = NiFpga_ConfigureFifo(m_session, n, depth);
//}
//
//void TerminalsDMACommon::configureAllDMAs(const size_t depth) const {
//
//}

void TerminalsDMACommon::startDMAImpl(
...
void TerminalsDMACommon::cleanDMAImpl(
		const std::uint32_t &dma) const {
...
TerminalsDMACommon::FrameType TerminalsDMACommon::getFrameType(const std::uint32_t n) const {
...
std::vector<TerminalsDMACommon::FrameType> TerminalsDMACommon::getAllFrameType() const {
	return m_frameType;
}
